# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.0b1 on Sun Nov  8 11:02:26 2020
#
...
class TopFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        grid_sizer_1 = wx.FlexGridSizer(11, 5, 0, 0)
        ...
        lblStorage = wx.StaticText(self.panel_1, wx.ID_ANY, "Write local Logs:")
        grid_sizer_1.Add(lblStorage, 1, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 2)

        self.cbxUseLocalLogs = wx.CheckBox(self.panel_1, wx.ID_ANY, "")
        ...
        lblLocalLogLocation = wx.StaticText(self.panel_1, wx.ID_ANY, "Local Log Path:")
        grid_sizer_1.Add(lblLocalLogLocation, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 2)

        self.txtLocalLogLocation = wx.TextCtrl(self.panel_1, wx.ID_ANY, "")
        ...
        label_1 = wx.StaticText(self.panel_1, wx.ID_ANY, "Use Remote Data Host:")
        grid_sizer_1.Add(label_1, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 2)

        self.cbxUseRmtDataHost = wx.CheckBox(self.panel_1, wx.ID_ANY, "")
        ...
        label_2 = wx.StaticText(self.panel_1, wx.ID_ANY, "Remote Data Host Address:")
        grid_sizer_1.Add(label_2, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 2)

        self.txtRemoteHostAddr = wx.TextCtrl(self.panel_1, wx.ID_ANY, "")
        ...
        label_5 = wx.StaticText(self.panel_1, wx.ID_ANY, "I2C Sensor Bus #:")
        grid_sizer_1.Add(label_5, 0, wx.ALL, 2)

        self.txtSensorBus = wx.TextCtrl(self.panel_1, wx.ID_ANY, "")
        ...
        label_3 = wx.StaticText(self.panel_1, wx.ID_ANY, "Use Magnetometer Sensor #1")
        ...
        label_6 = wx.StaticText(self.panel_1, wx.ID_ANY, "Sensor #1 Bus Address:")
        grid_sizer_1.Add(label_6, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 2)

        self.txtSensor1Addr = wx.SpinCtrl(self.panel_1, wx.ID_ANY, "0", min=0, max=100)
        grid_sizer_1.Add(self.txtSensor1Addr, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 2)

        grid_sizer_1.Add((0, 0), 0, 0, 0)

        label_4 = wx.StaticText(self.panel_1, wx.ID_ANY, "Use Magnetometer Sensor #2")
        ...
        label_7 = wx.StaticText(self.panel_1, wx.ID_ANY, "Sensor #2 Bus Address:")
        grid_sizer_1.Add(label_7, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 2)

        self.txtSensor2Addr = wx.SpinCtrl(self.panel_1, wx.ID_ANY, "0", min=0, max=100)
        grid_sizer_1.Add(self.txtSensor2Addr, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 2)
        ...
        bitmap_1 = wx.StaticBitmap(self.topRightWebPane, wx.ID_ANY, wx.Bitmap("./bitmaps/Cabin in the Romanian woods.jpg", wx.BITMAP_TYPE_ANY))
        sizer_6.Add(bitmap_1, 0, wx.ALL, 2)
